...
M.options = {
  ...
  { text = "Zig test program", value = "option3" },
}
  ...
  if selected_option == "option1" then
    local task = overseer.new_task({
      ...
      strategy = {
        ...
        tasks = {
          {
            name = '- Build & run program → "./build.zig"',
            cmd = "zig build run "
              .. arguments -- compile and run
              .. ' && echo "'
              .. final_message
              .. '"',
  ...
  elseif selected_option == "option3" then
    local task = overseer.new_task({
      ...
      strategy = {
        ...
        tasks = {
          {
            name = '- Test Program → "./src/tests.zig"',
            cmd = "zig test src/tests.zig"
              .. arguments -- compile
              .. ' && echo "'
              .. final_message
              .. '"',
